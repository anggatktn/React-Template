...
const OrderTrackingCard: React.FC<{ style?: React.CSSProperties }> = ({ style }) => {
    return (
        <div style={{ height: '100%', display: 'flex', flexDirection: 'column', marginTop: 30, ...style }}>
            ...
            <Card bordered={false} style={{ borderRadius: 8, flex: 1 }}>
                <Row style={{ padding: '12px 0' }}>
                    ...
                    <Col span={16} style={{ paddingLeft: 16 }}>
                        <Text strong>Shipping Cost Updated</Text>
                    </Col>
                </Row>
                <Row style={{ padding: '12px 0' }}>
                    <Col span={8} style={{ borderRight: '1px solid #f0f0f0', paddingRight: 16, textAlign: 'right' }}>
